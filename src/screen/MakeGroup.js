...
const MakeGroup = ({navigation}) => {
    ...
    const modalToggle = () => {
      ...
      const completeMakeGroup = useCallback(() =>{
        Snackbar.show({
          text: '새로운 그룹이 생성되었습니다.',
     ...
     <SafeAreaView style={{backgroundColor: 'black', flex: 1}}>
       ...
       <View style={{ padding: '3%'}}>
         <View style={{paddingHorizontal: 10, paddingVertical: 15 }}>
           <Text style={{ color: 'white', fontSize: 30, fontWeight: 'bold', textAlign:'center' }}>그룹 생성하기</Text>
         </View>
       <View>
